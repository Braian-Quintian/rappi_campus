...
export const repartidoresDtoPost = [
    body('dni-repartidor').notEmpty().isNumeric().withMessage('El dni es requerido')
    .matches(/^[0-9]+$/).withMessage('El dni debe ser un numero'),
    body('nombre-repartidor').notEmpty().isString().withMessage('El nombre es requerido')
    .matches(/^[a-zA-Z ]+$/).withMessage('El nombre debe ser un string'),
    body('apellido-repartidor').notEmpty().isString().withMessage('El apellido es requerido')
    .matches(/^[a-zA-Z ]+$/).withMessage('El apellido debe ser un string'),
    body('telefono-repartidor').notEmpty().isNumeric().withMessage('El telefono es requerido')
    .matches(/^[0-9]+$/).withMessage('El telefono debe ser un numero'),
    body('correo-repartidor').notEmpty().isEmail().withMessage('El correo debe ser un email y es requerido'),
    body('contraseña-repartidor').notEmpty().isString().withMessage('La contraseña es requerida')
    .matches(/^[a-zA-Z0-9]+$/).withMessage('La contraseña debe ser un string'),
    body('cumpleaños-repartidor').notEmpty().withMessage('El cumpleaños es requerido')
    ...
    body('vehiculo-modelo').notEmpty().isString().withMessage('El modelo es requerido')
    .matches(/^[a-zA-Z0-9]+$/).withMessage('El modelo debe ser un string'),
    body('vehiculo-placa').notEmpty().isString().withMessage('La placa es requerida')
    .matches(/^[a-zA-Z0-9]+$/).withMessage('La placa debe ser un string'),
    body('vehiculo-color').notEmpty().isString().withMessage('El color es requerido')
    .matches(/^[a-zA-Z]+$/).withMessage('El color debe ser un string'),
    body('tipo-vehiculo').notEmpty().withMessage('El tipo es requerido')
...
export const repartidoresDtoPut = [
    param('id').notEmpty().isNumeric().withMessage('El id es requerido')
    .matches(/^[0-9]+$/).withMessage('El id debe ser un numero'),
    body('telefono-repartidor').notEmpty().isNumeric().withMessage('El dni es requerido')
    .matches(/^[0-9]+$/).withMessage('El dni debe ser un numero'),
